...
namespace ParkingManagement.Library
{
    ...
    class BillPrint
    {
        ...
        private void PrintTicket(Graphics G)
        {
            ...
            G.DrawString("Discount :", new Font(new FontFamily(Font), 9), Brushes.Black, new RectangleF(550, i, 95, 20));
            G.DrawString(PSales.Discount.ToString("#,##,##0.00"), new Font(new FontFamily(Font), 9, FontStyle.Bold), Brushes.Black, new RectangleF(650, i, 120, 20), format);
            i += 18;
