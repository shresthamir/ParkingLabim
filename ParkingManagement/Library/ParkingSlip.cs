...
namespace ParkingManagement.Library
{
    ...
    public class BillPrint
    {
        ...
        public BillPrint()
        {
            PD = new PrintDocument();
            PD.PrinterSettings.PrinterName = GlobalClass.PrinterName;
            PrintWidth = PD.PrinterSettings.PaperSizes[0].Width;
            PD.PrintPage += PD_PrintPage;
        }
        ...
        private void PrintTicket(Graphics G)
        {
            ...
            G.DrawString(CompanyName, new Font(new FontFamily(Font), 9), Brushes.Black, new RectangleF(0, i, PrintWidth, 17), format);
            i += 17;

            G.DrawString(CompanyAddress, new Font(new FontFamily(Font), 9), Brushes.Black, new RectangleF(0, i, 300, 17), format);
            i += 17;

            G.DrawString("Parking Slip", new Font(new FontFamily(Font), 9), Brushes.Black, new RectangleF(0, i, 300, 20), format);
            i += 18;
